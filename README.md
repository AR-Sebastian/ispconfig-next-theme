...
![NEXT-Dashboard der installierten Version 1.2.4](docs/images/dashboard-runtime-v1.2.4.png)
...
![NEXT dashboard from installed version 1.2.4](docs/images/dashboard-runtime-v1.2.4.png)
